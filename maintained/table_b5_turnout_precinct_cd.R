# coppock_green_porter_2022/maintained/table_b5_turnout_precinct_cd.R
# Output: output/table_b5_turnout_precinct_cd.csv, output/table_b5_turnout_precinct_cd.tex,
#   output/table_b5_turnout_precinct_cd_gof.csv
# Depends on: CGP_2022_precinct_level.rds, helpers.R
# Description: Reproduces appendix Table B.5, the turnout models with fixed effects for
...
write_csv(results, here::here("maintained", "output", "table_b5_turnout_precinct_cd.csv"))
...
write_csv(gof, here::here("maintained", "output", "table_b5_turnout_precinct_cd_gof.csv"))
...
modelsummary(
  fits,
  output = here::here("maintained", "output", "table_b5_turnout_precinct_cd.tex"),
  coef_map = coef_labels,
  gof_map = gof_map_lm(2),
  fmt = 2,
  stars = c("*" = 0.05),
  title = "Table B.5: Effects on turnout (CD fixed effects)",
