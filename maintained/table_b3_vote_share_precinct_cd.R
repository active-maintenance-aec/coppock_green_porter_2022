...
#   of Table B.4 under the vote share caption, so the numbers below appear nowhere in
#   the published appendix; see the errata section of the report.
...
modelsummary(
  fits,
  output = here::here("maintained", "output", "table_b3_vote_share_precinct_cd.tex"),
